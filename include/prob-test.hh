...
DefaultNodes<...>::ChanceNode happens to be a generic linked-list backed set
impl. we don't have to worry about hash collisions with std::unordered_map
...
typename Types::Prob prob_test(typename Types::PRNG &device, size_t tries,
  ...
  std::cout << "prob test count: " << chance_node.count_matrix_nodes()
            << std::endl;
