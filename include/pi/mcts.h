...
private:
  ...
  void init_stats_and_rollout(auto& stats, auto& prng, pkmn_gen1_battle *battle, pkmn_result result) {

    const auto p1_choices = pkmn_gen1_battle_choices(battle, PKMN_PLAYER_P1, pkmn_result_p1(result), choices.data(), PKMN_GEN1_MAX_CHOICES);
    const auto p2_choices = pkmn_gen1_battle_choices(battle, PKMN_PLAYER_P2, pkmn_result_p2(result), choices.data(), PKMN_GEN1_MAX_CHOICES);
